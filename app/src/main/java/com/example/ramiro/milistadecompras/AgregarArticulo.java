...
public class AgregarArticulo extends Activity implements OnClickListener {
    EditText et;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et = (EditText) findViewById(R.id.et_articulo_id);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.btnAgregarId:
                ...
                Intent main = new Intent(AgregarArticulo.this, MainActivity.class)
